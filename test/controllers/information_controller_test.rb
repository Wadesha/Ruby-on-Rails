...
class InformationControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create information" do
    assert_difference("Information.count") do
      post information_index_url, params: { information: { author: @information.author, category: @information.category, content: @information.content, status: @information.status, title: @information.title } }
    end
  ...
  test "should update information" do
    patch information_url(@information), params: { information: { author: @information.author, category: @information.category, content: @information.content, status: @information.status, title: @information.title } }
